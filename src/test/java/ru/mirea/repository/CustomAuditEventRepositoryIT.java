...
import ru.mirea.config.audit.AuditEventConverter;
import ru.mirea.domain.PersistentAuditEvent;
...
import static ru.mirea.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
